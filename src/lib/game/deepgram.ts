/**
 * Start audio stream from microphone, connects and pipes audio stream to DeepGram STT service endpoint.
 * @param cb - Callback function to call on final transcription
 * @returns DeepGram websocket
 */
